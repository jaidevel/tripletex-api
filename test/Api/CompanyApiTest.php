...
class CompanyApiTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test case for companyDivisionsGetDivisions
     *
     * [DEPRECATED] Find divisions..
     *
     */
    public function testCompanyDivisionsGetDivisions()
    {
    }
    ...
    /**
     * Test case for companyWithLoginAccessGetWithLoginAccess
     *
     * Returns client customers (with accountant/auditor relation) where the current user has login access (proxy login)..
     *
     */
    public function testCompanyWithLoginAccessGetWithLoginAccess()
    {
    }
}
