...
class Order implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'attn' => '\Swagger\Client\Model\Contact',
        'receiver_email' => 'string',
        'overdue_notice_email' => 'string',
        'number' => 'string',
        'reference' => 'string',
        'our_contact' => '\Swagger\Client\Model\Contact',
        'our_contact_employee' => '\Swagger\Client\Model\Employee',
     ...
     * Sets attn
     *
     * @param \Swagger\Client\Model\Contact $attn attn
     *
     * @return $this
     */
     ...
     * Sets our_contact
     *
     * @param \Swagger\Client\Model\Contact $our_contact If the contact is not an employee
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Employee $our_contact_employee If the contact is an employee
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\DeliveryAddress $delivery_address Delivery address of this order. This can be a new or existing address (useful to know, especially if the delivery is to a private person: if 'deliveryAddress.name' is set, we ignore the state of 'customer.id')
     *
     * @return $this
     */
     ...
     * Sets order_lines
     *
     * @param \Swagger\Client\Model\OrderLine[] $order_lines Order lines tied to the order. New OrderLines may be embedded here, in some endpoints.
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Invoice $preliminary_invoice [BETA] Preliminary invoice if order is not charged
     *
     * @return $this
     */
     ...
     * Sets attachment
     *
     * @param \Swagger\Client\Model\Document[] $attachment [BETA] Attachments belonging to this order
     *
     * @return $this
     */
