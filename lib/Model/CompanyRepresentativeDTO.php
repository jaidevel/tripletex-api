...
class CompanyRepresentativeDTO implements ModelInterface, ArrayAccess
{
    ...
    const SIGNATURE_STATUS_UNKNOWN = 'UNKNOWN';
    const SIGNATURE_STATUS_NOT_SIGNED = 'NOT_SIGNED';
    const SIGNATURE_STATUS_PENDING_SIGNATURE = 'PENDING_SIGNATURE';
    ...
    {
        return [
            self::SIGNATURE_STATUS_UNKNOWN,
            self::SIGNATURE_STATUS_NOT_SIGNED,
            self::SIGNATURE_STATUS_PENDING_SIGNATURE,
            self::SIGNATURE_STATUS_SIGNED,
        ];
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['signature_status']) && !in_array($this->container['signature_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'signature_status', must be one of '%s'",
