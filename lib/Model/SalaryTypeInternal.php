...
/**
 * SalaryTypeInternal Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SalaryTypeInternal implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SalaryTypeInternal';
    ...
    public function setNumber($number)
    {
        if (!is_null($number) && (mb_strlen($number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $number when calling SalaryTypeInternal., must be smaller than or equal to 10.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SalaryTypeInternal., must be smaller than or equal to 255.');
        }
