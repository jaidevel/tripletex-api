...
/**
 * SalarySpecSupplementInternal Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SalarySpecSupplementInternal implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SalarySpecSupplementInternal';
    ...
    protected static $swaggerTypes = [
        ...
        'url' => 'string',
        'salary_specification' => '\Swagger\Client\Model\SalarySpecification',
        'country' => '\Swagger\Client\Model\Country',
        'tax_country' => '\Swagger\Client\Model\Country',
     ...
     *
     * @return \Swagger\Client\Model\SalarySpecification
     */
     ...
     *
     * @param \Swagger\Client\Model\SalarySpecification $salary_specification salary_specification
     *
     * @return $this
     */
     ...
     * Sets tax_country
     *
     * @param \Swagger\Client\Model\Country $tax_country tax_country
     *
     * @return $this
     */
    ...
    public function setCarRegistrationNumber($car_registration_number)
    {
        if (!is_null($car_registration_number) && (mb_strlen($car_registration_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $car_registration_number when calling SalarySpecSupplementInternal., must be smaller than or equal to 20.');
        }
