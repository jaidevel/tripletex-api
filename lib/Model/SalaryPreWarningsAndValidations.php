...
/**
 * SalaryPreWarningsAndValidations Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SalaryPreWarningsAndValidations implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SalaryPreWarningsAndValidations';
    ...
    {
        $this->container['warning_messages'] = isset($data['warning_messages']) ? $data['warning_messages'] : null;
     ...
     *
     * @param string[] $warning_messages warning_messages
     *
     * @return $this
     */
     ...
     *
     * @param string[] $validation_messages validation_messages
     *
     * @return $this
     */
