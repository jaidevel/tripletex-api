...
class CurrencyExchangeRate implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'url' => 'string',
        'target_currency' => '\Swagger\Client\Model\Currency',
        'source_currency' => '\Swagger\Client\Model\Currency',
        'rate' => 'float',
        'source' => 'string',
        'date' => 'string'
    ];
     ...
     *
     * @param \Swagger\Client\Model\Currency $target_currency target_currency
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\Currency $source_currency source_currency
     *
     * @return $this
     */
