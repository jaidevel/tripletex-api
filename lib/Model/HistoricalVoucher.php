...
class HistoricalVoucher implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'postings' => '\Swagger\Client\Model\HistoricalPosting[]'
    ];
     ...
     * Sets voucher_type
     *
     * @param \Swagger\Client\Model\VoucherType $voucher_type Voucher type. Optional. Must not be of type 'Utgående faktura' ('Outgoing Invoice') on new vouchers, instead use voucherType=null or use the Invoice endpoint.
     *
     * @return $this
     */
     ...
     * Gets postings
     *
     * @return \Swagger\Client\Model\HistoricalPosting[]
     */
     ...
     * Sets postings
     *
     * @param \Swagger\Client\Model\HistoricalPosting[] $postings The list of postings of the voucher. In postings, these fields must be provided: date, account, currency, amount, amountBasis, amountVat, amountCurrency, amountBasisCurrency.
     *
     * @return $this
     */
