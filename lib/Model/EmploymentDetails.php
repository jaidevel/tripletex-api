...
class EmploymentDetails implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Swagger\Client\Model\OccupationCode $occupation_code To find the right value to enter in this field, you could go to GET /employee/employment/occupationCode to get a list of valid ID's.
     *
     * @return $this
     */
