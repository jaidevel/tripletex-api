...
class TrialInfoAutomationDTO implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerFormats = [
        'total_could_be_automated' => 'int32',
    ...
    protected static $attributeMap = [
        'total_could_be_automated' => 'totalCouldBeAutomated',
    ...
    protected static $setters = [
        'total_could_be_automated' => 'setTotalCouldBeAutomated',
    ...
    protected static $getters = [
        'total_could_be_automated' => 'getTotalCouldBeAutomated',
    ...
    {
        $this->container['total_could_be_automated'] = isset($data['total_could_be_automated']) ? $data['total_could_be_automated'] : null;
    ...
    /**
     * Gets total_could_be_automated
     *
     * @return int
     */
    public function getTotalCouldBeAutomated()
    {
        return $this->container['total_could_be_automated'];
    }

    /**
     * Sets total_could_be_automated
     *
     * @param int $total_could_be_automated total_could_be_automated
     *
     * @return $this
     */
    public function setTotalCouldBeAutomated($total_could_be_automated)
    {
        $this->container['total_could_be_automated'] = $total_could_be_automated;
