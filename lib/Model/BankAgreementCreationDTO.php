...
class BankAgreementCreationDTO implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'bank_accounts' => '\Swagger\Client\Model\Account[]'
    ];
     ...
     * Sets bank_accounts
     *
     * @param \Swagger\Client\Model\Account[] $bank_accounts JSON representing a list of new objects to be created. Should not have ID and version set.
     *
     * @return $this
     */
