...
/**
 * SalaryVoucherInternal Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SalaryVoucherInternal implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SalaryVoucherInternal';
    ...
    protected static $swaggerTypes = [
        ...
        'date' => 'string',
        'number' => 'int',
        'reverse_voucher' => '\Swagger\Client\Model\SalaryVoucherInternal',
    ...
    public function setNumber($number)
    {
        ...
        if (!is_null($number) && ($number < 0)) {
            throw new \InvalidArgumentException('invalid value for $number when calling SalaryVoucherInternal., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param \Swagger\Client\Model\SalaryVoucherInternal $reverse_voucher reverse_voucher
     *
     * @return $this
     */
