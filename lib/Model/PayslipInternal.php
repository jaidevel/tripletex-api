...
/**
 * PayslipInternal Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PayslipInternal implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PayslipInternal';
    ...
    protected static $swaggerTypes = [
        ...
        'url' => 'string',
        'transaction' => '\Swagger\Client\Model\SalaryTransactionInternal',
        'employee' => '\Swagger\Client\Model\SalaryEmployeeInternal',
        'date' => 'string',
        'year' => 'int',
        'month' => 'int',
        'specifications' => '\Swagger\Client\Model\SalarySpecificationInternal[]',
        'vacation_allowance_amount' => 'float',
        'gross_amount' => 'float',
        'amount' => 'float',
        'number' => 'int',
        'payslip_helper' => '\Swagger\Client\Model\PayslipHelperInternal',
        'sum_amount_tax_deductions' => 'float',
        'payroll_tax_amount' => 'float',
        'payroll_tax_basis' => 'float',
        'pre_warnings_and_validations' => '\Swagger\Client\Model\SalaryPreWarningsAndValidations'
    ];
    ...
    protected static $swaggerFormats = [
        ...
        'pre_warnings_and_validations' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'pre_warnings_and_validations' => 'preWarningsAndValidations'
    ];
    ...
    protected static $setters = [
        ...
        'amount' => 'setAmount',
        'number' => 'setNumber',
        'payslip_helper' => 'setPayslipHelper',
        ...
        'pre_warnings_and_validations' => 'setPreWarningsAndValidations'
    ];
    ...
    protected static $getters = [
        ...
        'amount' => 'getAmount',
        'number' => 'getNumber',
        'payslip_helper' => 'getPayslipHelper',
        ...
        'pre_warnings_and_validations' => 'getPreWarningsAndValidations'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['payslip_helper'] = isset($data['payslip_helper']) ? $data['payslip_helper'] : null;
        ...
        $this->container['pre_warnings_and_validations'] = isset($data['pre_warnings_and_validations']) ? $data['pre_warnings_and_validations'] : null;
    }
     ...
     * Gets transaction
     *
     * @return \Swagger\Client\Model\SalaryTransactionInternal
     */
     ...
     * Sets transaction
     *
     * @param \Swagger\Client\Model\SalaryTransactionInternal $transaction transaction
     *
     * @return $this
     */
     ...
     * Gets specifications
     *
     * @return \Swagger\Client\Model\SalarySpecificationInternal[]
     */
     ...
     * Sets specifications
     *
     * @param \Swagger\Client\Model\SalarySpecificationInternal[] $specifications Link to salary specifications.
     *
     * @return $this
     */
    ...
    public function setNumber($number)
    {
        ...
        if (!is_null($number) && ($number < 0)) {
            throw new \InvalidArgumentException('invalid value for $number when calling PayslipInternal., must be bigger than or equal to 0.');
        }
     ...
     * Gets payslip_helper
     *
     * @return \Swagger\Client\Model\PayslipHelperInternal
     */
    public function getPayslipHelper()
    {
        return $this->container['payslip_helper'];
    }

    /**
     * Sets payslip_helper
     *
     * @param \Swagger\Client\Model\PayslipHelperInternal $payslip_helper payslip_helper
     *
     * @return $this
     */
    public function setPayslipHelper($payslip_helper)
    {
        $this->container['payslip_helper'] = $payslip_helper;
    ...
    /**
     * Gets pre_warnings_and_validations
     *
     * @return \Swagger\Client\Model\SalaryPreWarningsAndValidations
     */
    public function getPreWarningsAndValidations()
    {
        return $this->container['pre_warnings_and_validations'];
    }

    /**
     * Sets pre_warnings_and_validations
     *
     * @param \Swagger\Client\Model\SalaryPreWarningsAndValidations $pre_warnings_and_validations pre_warnings_and_validations
     *
     * @return $this
     */
    public function setPreWarningsAndValidations($pre_warnings_and_validations)
    {
        $this->container['pre_warnings_and_validations'] = $pre_warnings_and_validations;
