...
class TripletexAccountPricesReturnDTO implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'all_prices' => 'map[string,map[string,\Swagger\Client\Model\TlxNumber]]',
        'sum_startup_category1_users' => '\Swagger\Client\Model\TlxNumber',
        'sum_service_category1_users' => '\Swagger\Client\Model\TlxNumber',
        'list_price_category1_user_startup' => '\Swagger\Client\Model\TlxNumber',
        'list_price_category1_user_service' => '\Swagger\Client\Model\TlxNumber',
        'sum_startup' => '\Swagger\Client\Model\TlxNumber',
        'sum_service' => '\Swagger\Client\Model\TlxNumber',
        'sum_yearly_service' => '\Swagger\Client\Model\TlxNumber'
    ];
     ...
     * Gets all_prices
     *
     * @return map[string,map[string,\Swagger\Client\Model\TlxNumber]]
     */
     ...
     * Sets all_prices
     *
     * @param map[string,map[string,\Swagger\Client\Model\TlxNumber]] $all_prices all_prices
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\TlxNumber $sum_startup_category1_users sum_startup_category1_users
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\TlxNumber $sum_service_category1_users sum_service_category1_users
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\TlxNumber $list_price_category1_user_startup list_price_category1_user_startup
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\TlxNumber $list_price_category1_user_service list_price_category1_user_service
     *
     * @return $this
     */
     ...
     * Sets sum_startup
     *
     * @param \Swagger\Client\Model\TlxNumber $sum_startup sum_startup
     *
     * @return $this
     */
     ...
     * Sets sum_service
     *
     * @param \Swagger\Client\Model\TlxNumber $sum_service sum_service
     *
     * @return $this
     */
     ...
     *
     * @param \Swagger\Client\Model\TlxNumber $sum_yearly_service sum_yearly_service
     *
     * @return $this
     */
