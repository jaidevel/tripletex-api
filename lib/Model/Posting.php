...
class Posting implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'amortization_account' => '\Swagger\Client\Model\Account',
     ...
     *
     * @param \Swagger\Client\Model\Account $amortization_account The Amortization account. AmortizationAccountId, amortizationStartDate and amortizationEndDate should be provided. If amortizationStartDate and amortizationEndDate are provided, while amortizationAccountId is NULL, then the default amortization account will be used.
     *
     * @return $this
     */
