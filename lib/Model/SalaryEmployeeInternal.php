...
/**
 * SalaryEmployeeInternal Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SalaryEmployeeInternal implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SalaryEmployeeInternal';
    ...
    public function setFirstName($first_name)
    {
        if (!is_null($first_name) && (mb_strlen($first_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling SalaryEmployeeInternal., must be smaller than or equal to 100.');
        }
    ...
    public function setLastName($last_name)
    {
        if (!is_null($last_name) && (mb_strlen($last_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling SalaryEmployeeInternal., must be smaller than or equal to 100.');
        }
    ...
    public function setEmployeeNumber($employee_number)
    {
        if (!is_null($employee_number) && (mb_strlen($employee_number) > 100)) {
            throw new \InvalidArgumentException('invalid length for $employee_number when calling SalaryEmployeeInternal., must be smaller than or equal to 100.');
        }
        if (!is_null($employee_number) && (mb_strlen($employee_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $employee_number when calling SalaryEmployeeInternal., must be bigger than or equal to 0.');
        }
