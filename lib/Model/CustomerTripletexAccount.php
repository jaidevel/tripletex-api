...
class CustomerTripletexAccount implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['customer_id']) && ($this->container['customer_id'] < 1)) {
            $invalidProperties[] = "invalid value for 'customer_id', must be bigger than or equal to 1.";
        }
     ...
     * Sets administrator
     *
     * @param \Swagger\Client\Model\Employee $administrator Administrator user to create in the new company. Leave empty if calling this enpoint as an auditor og accountant company
     *
     * @return $this
     */
    ...
    public function setCustomerId($customer_id)
    {
        ...
        if (!is_null($customer_id) && ($customer_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $customer_id when calling CustomerTripletexAccount., must be bigger than or equal to 1.');
        }
    ...
    public function setNumberOfEmployees($number_of_employees)
    {
        ...
        if (!is_null($number_of_employees) && ($number_of_employees < 0)) {
            throw new \InvalidArgumentException('invalid value for $number_of_employees when calling CustomerTripletexAccount., must be bigger than or equal to 0.');
        }
