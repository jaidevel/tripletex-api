...
class TravelExpenseApi
{
    ...
    protected function travelExpenseAttachmentDeleteAttachmentRequest($travel_expense_id, $version = null, $send_to_inbox = 'false', $split = 'false')
    {
        ...
        if ($version !== null && $version < 0) {
            throw new \InvalidArgumentException('invalid value for "$version" when calling TravelExpenseApi.travelExpenseAttachmentDeleteAttachment, must be bigger than or equal to 0.');
        }
     ...
     * @return void
     */
    public function travelExpenseAttachmentListUploadAttachments($travel_expense_id, $body, $create_new_cost = 'false')
    {
        $this->travelExpenseAttachmentListUploadAttachmentsWithHttpInfo($travel_expense_id, $body, $create_new_cost);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function travelExpenseAttachmentListUploadAttachmentsWithHttpInfo($travel_expense_id, $body, $create_new_cost = 'false')
    {
        $returnType = '';
        $request = $this->travelExpenseAttachmentListUploadAttachmentsRequest($travel_expense_id, $body, $create_new_cost);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function travelExpenseAttachmentListUploadAttachmentsAsync($travel_expense_id, $body, $create_new_cost = 'false')
    {
        return $this->travelExpenseAttachmentListUploadAttachmentsAsyncWithHttpInfo($travel_expense_id, $body, $create_new_cost)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function travelExpenseAttachmentListUploadAttachmentsAsyncWithHttpInfo($travel_expense_id, $body, $create_new_cost = 'false')
    {
        $returnType = '';
        $request = $this->travelExpenseAttachmentListUploadAttachmentsRequest($travel_expense_id, $body, $create_new_cost);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function travelExpenseAttachmentListUploadAttachmentsRequest($travel_expense_id, $body, $create_new_cost = 'false')
    {
        // verify the required parameter 'travel_expense_id' is set
        if ($travel_expense_id === null || (is_array($travel_expense_id) && count($travel_expense_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling travelExpenseAttachmentListUploadAttachments'
            );
        }
     ...
     * @return void
     */
    public function travelExpenseAttachmentUploadAttachment($travel_expense_id, $file, $create_new_cost = 'false')
    {
        $this->travelExpenseAttachmentUploadAttachmentWithHttpInfo($travel_expense_id, $file, $create_new_cost);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function travelExpenseAttachmentUploadAttachmentWithHttpInfo($travel_expense_id, $file, $create_new_cost = 'false')
    {
        $returnType = '';
        $request = $this->travelExpenseAttachmentUploadAttachmentRequest($travel_expense_id, $file, $create_new_cost);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function travelExpenseAttachmentUploadAttachmentAsync($travel_expense_id, $file, $create_new_cost = 'false')
    {
        return $this->travelExpenseAttachmentUploadAttachmentAsyncWithHttpInfo($travel_expense_id, $file, $create_new_cost)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function travelExpenseAttachmentUploadAttachmentAsyncWithHttpInfo($travel_expense_id, $file, $create_new_cost = 'false')
    {
        $returnType = '';
        $request = $this->travelExpenseAttachmentUploadAttachmentRequest($travel_expense_id, $file, $create_new_cost);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function travelExpenseAttachmentUploadAttachmentRequest($travel_expense_id, $file, $create_new_cost = 'false')
    {
        // verify the required parameter 'travel_expense_id' is set
        if ($travel_expense_id === null || (is_array($travel_expense_id) && count($travel_expense_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \Swagger\Client\Model\ListResponseTravelExpense
     */
    public function travelExpenseUndeliverUndeliver($id = null, $body = null)
    {
        list($response) = $this->travelExpenseUndeliverUndeliverWithHttpInfo($id, $body);
        return $response;
    }
     ...
     * @return array of \Swagger\Client\Model\ListResponseTravelExpense, HTTP status code, HTTP response headers (array of strings)
     */
    public function travelExpenseUndeliverUndeliverWithHttpInfo($id = null, $body = null)
    {
        $returnType = '\Swagger\Client\Model\ListResponseTravelExpense';
        $request = $this->travelExpenseUndeliverUndeliverRequest($id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function travelExpenseUndeliverUndeliverAsync($id = null, $body = null)
    {
        return $this->travelExpenseUndeliverUndeliverAsyncWithHttpInfo($id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function travelExpenseUndeliverUndeliverAsyncWithHttpInfo($id = null, $body = null)
    {
        $returnType = '\Swagger\Client\Model\ListResponseTravelExpense';
        $request = $this->travelExpenseUndeliverUndeliverRequest($id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function travelExpenseUndeliverUndeliverRequest($id = null, $body = null)
    {
