...
class InvoiceApi
{
     ...
     *
     * @param  \Swagger\Client\Model\Invoice[] $body JSON representing a list of new objects to be created. Should not have ID and version set. (optional)
     ...
     */
    public function invoiceListPostList($body = null, $send_to_customer = 'true', $fields = '*')
    {
        list($response) = $this->invoiceListPostListWithHttpInfo($body, $send_to_customer, $fields);
        return $response;
    }
     ...
     */
    public function invoiceListPostListWithHttpInfo($body = null, $send_to_customer = 'true', $fields = '*')
    {
        $returnType = '\Swagger\Client\Model\ListResponseInvoice';
        $request = $this->invoiceListPostListRequest($body, $send_to_customer, $fields);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function invoiceListPostListAsync($body = null, $send_to_customer = 'true', $fields = '*')
    {
        return $this->invoiceListPostListAsyncWithHttpInfo($body, $send_to_customer, $fields)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function invoiceListPostListAsyncWithHttpInfo($body = null, $send_to_customer = 'true', $fields = '*')
    {
        $returnType = '\Swagger\Client\Model\ListResponseInvoice';
        $request = $this->invoiceListPostListRequest($body, $send_to_customer, $fields);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function invoiceListPostListRequest($body = null, $send_to_customer = 'true', $fields = '*')
    {
