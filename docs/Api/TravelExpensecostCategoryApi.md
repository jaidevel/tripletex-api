...
------------- | ------------- | -------------
[**travelExpenseCostCategoryGet**](TravelExpensecostCategoryApi.md#travelExpenseCostCategoryGet) | **GET** /travelExpense/costCategory/{id} | Get cost category by ID.
[**travelExpenseCostCategorySearch**](TravelExpensecostCategoryApi.md#travelExpenseCostCategorySearch) | **GET** /travelExpense/costCategory | Find cost category corresponding with sent data.
