...
------------- | ------------- | -------------
[**deliveryAddressGet**](DeliveryAddressApi.md#deliveryAddressGet) | **GET** /deliveryAddress/{id} | Get address by ID.
[**deliveryAddressPut**](DeliveryAddressApi.md#deliveryAddressPut) | **PUT** /deliveryAddress/{id} | Update address.
[**deliveryAddressSearch**](DeliveryAddressApi.md#deliveryAddressSearch) | **GET** /deliveryAddress | Find addresses corresponding with sent data.
...
------------- | ------------- | ------------- | -------------
 **id** | **int**| Element ID |
 **body** | [**\Swagger\Client\Model\DeliveryAddress**](../Model/DeliveryAddress.md)| Partial object describing what should be updated | [optional]
