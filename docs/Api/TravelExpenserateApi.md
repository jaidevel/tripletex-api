...
------------- | ------------- | -------------
[**travelExpenseRateGet**](TravelExpenserateApi.md#travelExpenseRateGet) | **GET** /travelExpense/rate/{id} | Get travel expense rate by ID.
[**travelExpenseRateSearch**](TravelExpenserateApi.md#travelExpenseRateSearch) | **GET** /travelExpense/rate | Find rates corresponding with sent data.
