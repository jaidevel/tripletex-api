...
------------- | ------------- | -------------
[**salaryPayslipGet**](SalarypayslipApi.md#salaryPayslipGet) | **GET** /salary/payslip/{id} | Find payslip by ID.
[**salaryPayslipPdfDownloadPdf**](SalarypayslipApi.md#salaryPayslipPdfDownloadPdf) | **GET** /salary/payslip/{id}/pdf | Find payslip (PDF document) by ID.
[**salaryPayslipSearch**](SalarypayslipApi.md#salaryPayslipSearch) | **GET** /salary/payslip | Find payslips corresponding with sent data.
